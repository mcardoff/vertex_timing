void generate_dt() {
  ...
  /// Instead of nforward jet paradigm, do nforward tracks
  TH1F *reso_ftracks1 = new TH1F("reso_ftracks1", "RecoVtx t_{0} - TruthVtx t_{0} (nftracks);#Delta t;Entries", bins, -non_norm_bound, non_norm_bound);
  TH1F *reso_ftracks2 = new TH1F("reso_ftracks2", "RecoVtx t_{0} - TruthVtx t_{0} (nftracks);#Delta t;Entries", bins, -non_norm_bound, non_norm_bound);
  TH1F *reso_ftracks3 = new TH1F("reso_ftracks3", "RecoVtx t_{0} - TruthVtx t_{0} (nftracks);#Delta t;Entries", bins, -non_norm_bound, non_norm_bound);
  TH1F *reso_ftracks4 = new TH1F("reso_ftracks4", "RecoVtx t_{0} - TruthVtx t_{0} (nftracks);#Delta t;Entries", bins, -non_norm_bound, non_norm_bound);

  /// Store dt/res
  TH1F *reso_norm_ftracks1 = new TH1F("reso_norm_ftracks1", "(RecoVtx t_{0} - TruthVtx t_{0})/#sigma_{t}(nftracks);#Delta t;Entries", bins, -20, 20);
  TH1F *reso_norm_ftracks2 = new TH1F("reso_norm_ftracks2", "(RecoVtx t_{0} - TruthVtx t_{0})/#sigma_{t}(nftracks);#Delta t;Entries", bins, -20, 20);
  TH1F *reso_norm_ftracks3 = new TH1F("reso_norm_ftracks3", "(RecoVtx t_{0} - TruthVtx t_{0})/#sigma_{t}(nftracks);#Delta t;Entries", bins, -20, 20);
  TH1F *reso_norm_ftracks4 = new TH1F("reso_norm_ftracks4", "(RecoVtx t_{0} - TruthVtx t_{0})/#sigma_{t}(nftracks);#Delta t;Entries", bins, -20, 20);
  ...
  while (reader.Next()) {
	...
	hist_norm3->Fill(reso);
      } else if (nForwardJet > 2)  { // > 2 forward jet
	hist4->Fill(diff);
