  ...
  while (reader.Next()) {
    ...
    if (!pass_W) {
      ...
      if (waves_irreducible) {
        ...
        // works uniformly across every sample, unlike the old
        // rfind("._")/rfind(".SuperNtuple") extraction that only matched the
        // local default VBF ntuple's naming convention.
