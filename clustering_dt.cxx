...
void clustering_dt() {
  ...
  while (reader.Next()) {
    ...
    // if (readnum > 10000) break;
    process_event_data(&branch, false, true, false, hgtdtimes_resos, hgtdtimes_purity,
  ...
  plot_money(Form("figs/moneyplot_hstrack.pdf"), canvas,
	     hs_track_hgtdtimes, hs_track_idealres, hs_track_idealeff, hs_track_hgtdtimes_pur);

  plot_money(Form("figs/moneyplot_pufrac.pdf"), canvas,
	     pu_frac_hgtdtimes, pu_frac_idealres, pu_frac_idealeff,pu_frac_hgtdtimes_pur);

  plot_money(Form("figs/moneyplot_track.pdf"), canvas,
	     ftrack_hgtdtimes, ftrack_idealres, ftrack_idealeff, ftrack_hgtdtimes_pur);
