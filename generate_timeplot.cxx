...
void generate_timeplot() {
  ...
  int numpages = 1;
  canvas->Print(Form("trackhists_0fjet.pdf("), "pdf");
  canvas->Print(Form("trackhists_1fjet.pdf("), "pdf");
  canvas->Print(Form("trackhists_2fjet.pdf("), "pdf");
  canvas->Print(Form("trackhists_2pfjet.pdf("), "pdf");
  ...
  canvas->Print("trackhists_0fjet.pdf)", "pdf");
  canvas->Print("trackhists_1fjet.pdf)", "pdf");
  canvas->Print("trackhists_2fjet.pdf)", "pdf");
  canvas->Print("trackhists_2pfjet.pdf)", "pdf");
